...
insert into student(id, name, created_date, last_updated_date) values (20001, 'Alice', sysdate(), sysdate());
insert into student(id, name, created_date, last_updated_date) values (20002, 'Bob', sysdate(), sysdate());
insert into student(id, name, created_date, last_updated_date) values (20003, 'Cathy', sysdate(), sysdate());
